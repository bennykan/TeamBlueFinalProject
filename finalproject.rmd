...
We have removd the missing and outlier SALE.PRICE data.  We have reduced our dataset to 46220 oberservations.
...
plot(density(data_out$GROSS.SQUARE.FEET))

#Use log transformation to change to normal distrubution

plot(density(sapply(data_out$GROSS.SQUARE.FEET, log)))

#Update SALE.PRICE

data_out$GROSS.SQUARE.FEET <- sapply(data_out$GROSS.SQUARE.FEET, log)
```
...
plot(density(data_out$LAND.SQUARE.FEET))

#Use log transformation to change to normal distrubution

plot(density(sapply(data_out$LAND.SQUARE.FEET, log)))

#Update SALE.PRICE

data_out$LAND.SQUARE.FEET <- sapply(data_out$LAND.SQUARE.FEET, log)
