...
We created a user interface where the user can input the zip code, neighborhood, property type, square footage and the property age and then the model will predict the estimated price.
