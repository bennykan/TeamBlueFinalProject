...
The model has a Rsquared of 0.46, this means that the only 46% of the SALE.PRICE variable variation is explained by our linear model.  This was a lower Rquared then we expected since all of our variables are shown to be significant. We will now look at the residuals plot to see if they help determine if the linear model is good or not.
